...
/**
 * Thin fetch wrapper: every non-2xx response is turned into a thrown
 * ApiError using the API's single consistent error shape, so callers never
 * have to check `res.ok` themselves.
 */
